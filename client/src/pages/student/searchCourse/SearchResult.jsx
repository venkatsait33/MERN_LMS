...
const SearchResult = ({ course }) => {
    return (
        <div className='flex flex-col items-start justify-between gap-4 py-6 border-b border-gray-300 md:flex-row md:items-center '>
            <Link to={`/course-details/${course?._id}`}
                className='flex flex-col w-full gap-4 md:flex-row md:w-auto'>
                <img src={course.courseThumbnail} alt={course.courseTitle} className='object-cover w-full h-32 rounded-lg md:w-56 ' />
